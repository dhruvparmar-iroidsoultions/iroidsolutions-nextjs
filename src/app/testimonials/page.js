  ...
  return (
    <>
      ...
      <div className="container text-center">
        <h1 className="fw-semibold my-3 mt-md-5 pt-xl-4">Video Testimonials</h1>
        ...
        <VideoTestimonial />
        <h1 className="fw-semibold my-3 mt-md-5 pt-lg-5">
          Client Testimonials
        </h1>
        ...
        <div className="client-testimonials mx-auto px-2">
          <ClientTestimonial />
        </div>
